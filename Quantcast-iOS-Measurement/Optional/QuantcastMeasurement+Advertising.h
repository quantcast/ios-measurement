...
/*!
 ...
 @param inCampaignName A string that identifies the campaign being logged.   This can be nil
 @param inMedia         A String that identifies the media of this campaign.  This can be nil
 @param inPlacement      A String that identifies the placement of the media.  This can be nil
