...
1.	Import the code from the Quantcast-iOS-Measurement folder in the Quantcast repository you just created into your project.
...
#### <a id="UserOptOut"></a> User Opt-Out ####
...
#### <a id="TrackingAppEvents"></a>Tracking App Events ####
...
#### <a id="EventLabels"></a> Event Labels ####
...
While there is no specific constraint on the intended use of the label dimension, it is not recommended that you use it to indicate discrete events; in these cases, use the `logEvent:withLabels:` method described under [Tracking App Events](#TrackingAppEvents).

#### <a id="GeoLocationMeasurement"></a> Geo-Location Measurement ####
...
#### <a id="CombinedWebAppAudiences"></a> Combined Web/App Audiences ####
...
##### <a id="LoggingAndDebugging"></a>Logging and Debugging #####
...
##### <a id="EventUploadFrequency"></a>Event Upload Frequency #####
